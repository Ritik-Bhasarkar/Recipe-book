...
//Function to fetch meals from API if data is true
...
//funtion for randommeal API
const fetchRandomMeal =()=>{
  fetchMeals(randomMealUrl);
}


//function with property idMeal which will open the modal of that id
...
localStorage.setItem('favorites',JSON.stringify(updatedFavorites));
  ...
  return <AppContext.Provider value={{loading,meals,setSearchTerm,fetchRandomMeal,
    showModal,selectMeal,selectedMeal,closeModal,addToFavorites,removeFromFavorites,favorites}}>{children}</AppContext.Provider>;
};
